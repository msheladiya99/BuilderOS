...
const PROJECT_DATA = [
  { name: "Skyline Hts", sold: 84, available: 32, booked: 12 },
  { name: "Green Valley", sold: 56, available: 58, booked: 22 },
  { name: "Marina Cove", sold: 22, available: 88, booked: 18 },
  { name: "Prestige Twr", sold: 102, available: 14, booked: 8 },
];

const UNIT_STATUS = [
  { name: "Sold", value: 264, color: "#2563EB" },
  { name: "Booked", value: 60, color: "#F59E0B" },
  { name: "Available", value: 192, color: "#10B981" },
  { name: "Reserved", value: 24, color: "#8B5CF6" },
];

const RECENT_PAYMENTS = [
  { id: 1, customer: "Rahul Sharma", unit: "304, Skyline Hts", amount: "₹8.5L", date: "15 May", type: "EMI", status: "success" },
  { id: 2, customer: "Priya Patel", unit: "502, Green Valley", amount: "₹12L", date: "14 May", type: "Booking", status: "success" },
  { id: 3, customer: "Amit Desai", unit: "201, Marina Cove", amount: "₹5.2L", date: "13 May", type: "EMI", status: "pending" },
  { id: 4, customer: "Sunita Joshi", unit: "G02, Prestige Twr", amount: "₹22L", date: "12 May", type: "Full", status: "success" },
  { id: 5, customer: "Vikram Singh", unit: "701, Skyline Hts", amount: "₹4.8L", date: "11 May", type: "EMI", status: "overdue" },
];

const ACTIVITIES = [
  { id: 1, text: "New booking: Unit 205, Skyline Heights by Meena Krishnan", time: "30m", color: "emerald" },
  { id: 2, text: "Construction milestone: Block B, Floor 8 slab complete", time: "2h", color: "blue" },
  { id: 3, text: "Payment overdue: Vikram Singh — ₹4.8L pending", time: "3h", color: "red" },
  { id: 4, text: "New lead assigned to Ravi Sales team — 3BHK inquiry", time: "5h", color: "orange" },
  { id: 5, text: "KYC approved for Anita Mehta — Unit 602", time: "8h", color: "emerald" },
];

const CONSTRUCTION_PROGRESS = [
  { name: "Skyline Heights", progress: 78, stage: "Finishing" },
  { name: "Green Valley", progress: 45, stage: "Structure" },
  { name: "Marina Cove", progress: 22, stage: "Foundation" },
  { name: "Prestige Towers", progress: 95, stage: "Handover" },
];
  ...
  return (
    <div className="p-5 space-y-5 max-w-[1600px]">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Revenue" value="₹148.6 Cr" change="18.4%" positive sub="FY 2025-26" icon={IndianRupee} color="blue" />
        <StatCard title="Units Sold" value="264" change="12 units" positive sub="540 total units" icon={Building2} color="emerald" />
        <StatCard title="Pending Dues" value="₹24.8 Cr" change="3.2%" positive={false} sub="68 customers" icon={AlertCircle} color="orange" />
        <StatCard title="Active Leads" value="342" change="28 new" positive sub="CRM pipeline" icon={Users} color="blue" />
      </div>
