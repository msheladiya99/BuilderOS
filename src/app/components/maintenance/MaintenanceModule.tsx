...
const TICKETS = [
  { id: "TK-1042", unit: "304, Skyline Hts", owner: "Rahul Sharma", issue: "AC not cooling properly", category: "HVAC", priority: "High", status: "Open", reported: "14 May", assigned: "AC Technician" },
  { id: "TK-1041", unit: "502, Green Valley", owner: "Priya Patel", issue: "Water leakage in bathroom ceiling", category: "Plumbing", priority: "Urgent", status: "In Progress", reported: "13 May", assigned: "Plumber Team" },
  { id: "TK-1040", unit: "102, Skyline Hts", owner: "Kavitha Nair", issue: "Elevator not working - Floor 1", category: "Electrical", priority: "Urgent", status: "Resolved", reported: "12 May", assigned: "Elevator Co." },
  { id: "TK-1039", unit: "402, Prestige Twr", owner: "Meena Krishnan", issue: "Gym equipment repair needed", category: "Amenity", priority: "Low", status: "Open", reported: "11 May", assigned: "Unassigned" },
  { id: "TK-1038", unit: "201, Marina Cove", owner: "Amit Desai", issue: "Main door lock not working", category: "Carpentry", priority: "Medium", status: "In Progress", reported: "10 May", assigned: "Carpenter" },
];

const MAINTENANCE_BILLS = [
  { id: "MB-0542", owner: "Rahul Sharma", unit: "304, Skyline Hts", month: "May 2026", amount: "₹3,500", due: "10 Jun", status: "Unpaid" },
  { id: "MB-0541", owner: "Priya Patel", unit: "502, Green Valley", month: "May 2026", amount: "₹4,200", due: "10 Jun", status: "Paid" },
  { id: "MB-0540", owner: "Meena Krishnan", unit: "402, Skyline Hts", month: "May 2026", amount: "₹3,500", due: "10 Jun", status: "Unpaid" },
  { id: "MB-0539", owner: "Vikram Singh", unit: "701, Skyline Hts", month: "May 2026", amount: "₹5,000", due: "10 Jun", status: "Overdue" },
  { id: "MB-0538", owner: "Sunita Joshi", unit: "203, Skyline Hts", month: "Apr 2026", amount: "₹3,500", due: "10 May", status: "Paid" },
];
              ...
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`text-xs font-mono font-semibold ${muted}`}>{t.id}</span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className={`divide-y ${isDark ? "divide-slate-700/50" : "divide-slate-100"}`}>
                {MAINTENANCE_BILLS.map(bill => (
                  <tr key={bill.id} className={`hover:${isDark ? "bg-slate-700/30" : "bg-slate-50"}`}>
                    <td className={`px-4 py-3 text-xs font-mono ${text}`}>{bill.id}</td>
