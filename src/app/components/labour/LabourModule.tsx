...
const CONTRACTORS = [
  { id: 1, name: "Ranjit Construction Co.", type: "Civil", contact: "+91 98700 11234", workers: 85, location: "Andheri, Mumbai", rate: "₹320/day", status: "Active", totalBilled: "₹42.8L" },
  { id: 2, name: "Sharma Electricals", type: "Electrical", contact: "+91 87600 22345", workers: 24, location: "Borivali, Mumbai", rate: "₹480/day", status: "Active", totalBilled: "₹8.4L" },
  { id: 3, name: "Kumar Plumbers", type: "Plumbing", contact: "+91 76500 33456", workers: 18, location: "Thane", rate: "₹420/day", status: "Active", totalBilled: "₹5.2L" },
  { id: 4, name: "Steel Benders Ltd", type: "Steel Fixing", contact: "+91 65400 44567", workers: 32, location: "Mulund", rate: "₹350/day", status: "On Leave", totalBilled: "₹18.6L" },
];
...
const WORK_ORDERS = [
  { id: "WO-1024", contractor: "Ranjit Construction", work: "RCC Column casting - Block C Floor 8", start: "10 May", end: "20 May", value: "₹4,80,000", status: "In Progress" },
  { id: "WO-1023", contractor: "Sharma Electricals", work: "Electrical conduit laying - Block B Floor 6-8", start: "05 May", end: "18 May", value: "₹1,20,000", status: "In Progress" },
  { id: "WO-1022", contractor: "Kumar Plumbers", work: "Plumbing rough work - Block A Floor 10-12", start: "01 May", end: "14 May", value: "₹85,000", status: "Completed" },
  { id: "WO-1021", contractor: "Steel Benders Ltd", work: "Beam slab reinforcement - Block C Floor 7", start: "28 Apr", end: "08 May", value: "₹2,20,000", status: "Completed" },
];
              ...
              <tbody className={`divide-y ${isDark ? "divide-slate-700/50" : "divide-slate-100"}`}>
                {WORK_ORDERS.map(w => (
                  <tr key={w.id} className={`hover:${isDark ? "bg-slate-700/30" : "bg-slate-50"}`}>
                    <td className={`px-4 py-3 text-xs font-mono font-semibold ${text}`}>{w.id}</td>
