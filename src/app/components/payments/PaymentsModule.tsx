...
const PENDING_DUES = [
  { id: 1, customer: "Vikram Singh", unit: "701, Skyline Hts", due: "₹4,80,000", dueDate: "10 May 2026", overdue: 5, mobile: "+91 54321 09876", type: "EMI", totalPaid: "₹82L" },
  { id: 2, customer: "Amit Desai", unit: "201, Marina Cove", due: "₹3,60,000", dueDate: "12 May 2026", overdue: 3, mobile: "+91 76543 33456", type: "EMI", totalPaid: "₹20L" },
  { id: 3, customer: "Rajan Mehta", unit: "304, Green Valley", due: "₹5,20,000", dueDate: "15 May 2026", overdue: 0, mobile: "+91 98765 11234", type: "BLC", totalPaid: "₹45L" },
  { id: 4, customer: "Pooja Rao", unit: "201, Prestige Twr", due: "₹8,40,000", dueDate: "20 May 2026", overdue: 0, mobile: "+91 21098 88901", type: "EMI", totalPaid: "₹62L" },
  { id: 5, customer: "Kavitha Nair", unit: "302, Skyline Hts", due: "₹2,80,000", dueDate: "05 May 2026", overdue: 10, mobile: "+91 43210 66789", type: "EMI", totalPaid: "₹28L" },
];
...
const RECENT_PAYMENTS = [
  { id: 1, receipt: "RCP-8042", customer: "Rahul Sharma", unit: "304, Skyline", amount: "₹8,50,000", date: "15 May", mode: "NEFT", type: "EMI" },
  { id: 2, receipt: "RCP-8041", customer: "Priya Patel", unit: "502, Green Valley", amount: "₹12,00,000", date: "14 May", mode: "Cheque", type: "Booking" },
  { id: 3, receipt: "RCP-8040", customer: "Sunita Joshi", unit: "203, Skyline", amount: "₹37,20,000", date: "13 May", mode: "RTGS", type: "Full" },
  { id: 4, receipt: "RCP-8039", customer: "Meena Krishnan", unit: "402, Skyline", amount: "₹9,80,000", date: "12 May", mode: "NEFT", type: "EMI" },
  { id: 5, receipt: "RCP-8038", customer: "Arun Khanna", unit: "104, Marina", amount: "₹15,00,000", date: "11 May", mode: "UPI", type: "EMI" },
];
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className={`w-full max-w-lg rounded-2xl border shadow-2xl ${isDark ? "bg-slate-900 border-slate-700" : "bg-white border-slate-200"}`}>
            ...
            <div className="p-5 space-y-4">
              {[
                { label: "Customer Name", placeholder: "Search customer..." },
                { label: "Unit", placeholder: "Select unit" },
                { label: "Payment Amount (₹)", placeholder: "0.00" },
                { label: "Payment Date", placeholder: "", type: "date" },
                { label: "Payment Mode", placeholder: "NEFT / RTGS / Cheque / UPI" },
                { label: "Transaction Reference", placeholder: "Ref/Cheque number" },
                { label: "Payment Type", placeholder: "EMI / Booking / Full Payment" },
                { label: "Remarks", placeholder: "Optional notes..." },
              ].map(f => (
                <div key={f.label}>
                  <label className={`block text-xs font-medium mb-1.5 ${isDark ? "text-slate-300" : "text-slate-700"}`}>{f.label}</label>
                  <input type={f.type || "text"} placeholder={f.placeholder} className={`w-full px-3 py-2.5 rounded-xl border text-sm outline-none focus:border-blue-500 ${isDark ? "bg-slate-800 border-slate-700 text-white placeholder-slate-500" : "bg-slate-50 border-slate-200 text-slate-800"}`} />
                </div>
              ))}
            </div>
            <div className={`flex justify-end gap-3 px-5 py-4 border-t ${border}`}>
              ...
              <button onClick={() => setShowPaymentForm(false)} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-medium">Save & Generate Receipt</button>
            </div>
          </div>
        </div>
      )}
